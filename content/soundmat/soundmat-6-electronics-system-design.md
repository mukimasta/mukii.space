...
aliases:
  - /soundmat/soundmat-6-electronics-system-design/
...
传感器阵列的原理及设计详见 [SoundMat (5)  传感器原理及设计](/soundmat/soundmat-5-sensor-principles-and-design/)，此处讨论传感器的电子模块设计。
