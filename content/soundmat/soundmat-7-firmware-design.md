...
aliases:
  - /soundmat/soundmat-7-firmware-design/
...
[SoundMat (5)  传感器原理及设计](/soundmat/soundmat-5-sensor-principles-and-design/) 中提到了传感器检测的原理。在检测一个坐标 `(ring, slice)` 时，我们将当前 ring 对应引脚输出设置为 HIGH，其他设置为 LOW，然后读取 slice 端的电压，也就是调整 MUX 控制信号使其输出当前 slice 的信号并读取。
...
引脚对应，与 [SoundMat (11)  电子系统制造](/soundmat/soundmat-11-electronics-manufacturing/) 相同。
